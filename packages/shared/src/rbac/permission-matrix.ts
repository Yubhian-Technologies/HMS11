...
export const PERMISSION_MATRIX: Record<ModuleName, ModulePermissions> = {
  ...
  roomsWardsBeds: { super_admin: R, admin: CRUS, office: R, reception: R, doctor: R },
  ...
  labOrders: { super_admin: R, admin: R, doctor: CR, lab: ["read", "update", "statusChange"], patient: R },
  ...
  admissions: { super_admin: R, admin: R, reception: R, doctor: CRUS, patient: R },
