...
const MODULES: { href: string; title: string; description: string }[] = [
  { href: "/office/slots", title: "Slot Approval", description: "Approve, reject, or block doctors' availability slots." },
  ...
  { href: "/office/doctor-availability", title: "Doctor Availability", description: "Ask a doctor to confirm slot capacity for a date." },
